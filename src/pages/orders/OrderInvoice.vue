		...
		<q-card-section class="no-padding q-ma-md">
			<div class="row justify-between">
				...
				<div class="col-7 q-px-sm">
					...
					<div class="text-caption multi-line">
						{{ order.store_address_full }}
					</div>
				</div>
				<div class="col-4">
		...
		<q-card-section class="no-padding q-ma-md">
			<div class="row justify-between">
				<div class="col-6 q-pr-xs">
					...
					<div class="text-body2 text-capitalize">
						{{ order.customer_name }}
					</div>
					<div class="text-caption text-italic q-mt-sm">
						Alamat Pengiriman:
					</div>
					<div class="text-body2 multi-line">
				...
				<tbody>
					...
					>
						...
						<td class="text-right">
							Rp{{
								digitSeparator(
									parseInt(detail.product_selling_price) +
										parseInt(detail.cost)
								)
							}}
						</td>
