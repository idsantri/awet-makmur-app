      ...
      <q-card-section class="q-pt-xs no-padding">
        ...
        >
          <q-item-section class="">
            <div class="text-h6">
              {{ product.name }}
              <span v-show="product.brand" class="text-body2 text-italic"
...
import { notifyWarningExpired } from "src/utils/notify";
...
try {
  ...
  if (status == 401 && message[1].toLowerCase().includes("login")) {
    message.forEach((msg) => {
